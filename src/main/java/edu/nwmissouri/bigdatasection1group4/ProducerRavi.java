...
public class ProducerRavi {
  ...
  private static String createSentence() {
    String[] nationalParks = { "Yellowstone national park","Yosemite National Park","Redwoods National Park","Missouri state park"};
    ...
    int number=(int) ((Math.random() * (maxIndex - minIndex)) + minIndex);
    //int[] randoms = r.ints(count, minIndex, maxIndex).toArray();

    return nationalParks[number]+".";
  }
}