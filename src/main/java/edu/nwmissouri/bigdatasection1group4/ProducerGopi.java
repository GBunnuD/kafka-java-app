...
public class ProducerGopi {
  ...
  private static String createSentence() {
    String[] actor = { "Balayya Babu", "JR NTR", "Prabhas", "Mahesh", "Madhavan", "Surya" };
    String[] movies = { "Legend", "RRR", "Baahubali", "Business Man", "Sakhi","Soorarai Pottru" };
    String[] prep = { "=", ",", "!=", "--->","/" };
    ...
    return actor[randoms[0]] + " " + prep[randoms[1]] + " " + movies[randoms[2]] + ".";
  }
}